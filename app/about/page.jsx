  ...
  <div className="about-page">
    <Link href="/">
      ...
      <div className="body--copy">
        ...
        <p>Our second product was an onchain <a href="posts/stp">subscription</a> <a href="posts/stpv2">protocol</a> and <a href="https://hypersub.xyz" target="_blank">user interface</a>, launched 6 months later in October of 2023. $1.2M was earned by 2,279 unique creators from 45,287 unique subscribers. Some of our favorites were <a href="https://hypersub.xyz/s/eic-quarterly-7ap108nf7bb4"><em className="italic">EIC Quarterly</em></a>, <a href="https://hypersub.xyz/s/the-yon-experience-w4nphk0hhc00/drops"><em className="italic">the yon experience</em></a>, <a href="https://hypersub.xyz/s/aether-8pvtiwcxwqo0"><em className="italic">Aether</em></a>, <a href="https://hypersub.xyz/s/mbranson/drops"><em className="italic">m/branson</em></a>, <a href="https://hypersub.xyz/s/the-geometric-circle/drops"><em className="italic">The Geometric Circle</em></a>, <a href="https://hypersub.xyz/s/atelie-407-o61meh6sieww/drops"><em className="italic">Ateliê 407</em></a>, and <a href="https://hypersub.xyz/s/patronsofblue/drops"><em className="italic">Patrons of Blue</em></a>.</p>
        
        <p>Our third product, launching in 2026, is a swap routing API, benchmarking tool, and user interface.</p>
        
        <p>With each iteration of the company we've learned, grown, and adapted to market reality. Though our products have taken many forms, our motivations remain the same: <em className="italic">permissionless capital coordination, efficient markets, economic freedom</em>.</p>
